...
7. Themenwechsel: Mathe! Beginnen wir mit Variablen. Ersetzt mal einen Farbwert / Koordinate durch eine und z.B. schiebt eure Pixel umher... Zur Namenswahl: Besser Namen wie r/g/b vermeiden und ausschreiben, da sonst mit "Named Parameters" (`r=r`) Verwirrung aufkommt
...
11. Rechner zu schnell? `time.sleep()` einführen mit Hinweis, wie Kommazahlen in Python funktionieren (`.` vs `,`).
